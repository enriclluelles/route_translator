...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency 'actionpack', '>= 5.0.0.1', '< 7.0'
  spec.add_runtime_dependency 'activesupport', '>= 5.0.0.1', '< 7.0'
  ...
  spec.add_development_dependency 'rubocop-minitest', '~> 0.11.1'
